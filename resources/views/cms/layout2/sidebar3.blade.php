            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  <li><a href="{{ route('request',['id' => encrypt(Auth::user()->company_detail_id)]) }}"><i class="fa fa-list"></i>Request Lists <span class="fa fa-chevron-right"></span></a>
                  </li>
                  <li><a href="{{ route('ridelist') }}"><i class="fa fa-car"></i>List of my Rides<span class="fa fa-chevron-right"></span></a>
                  </li>
                   <li><a href="{{ route('driverProfile') }}"><i class="fa fa-user"></i> Profile <span class="fa fa-chevron-right"></span></a>
                  </li>
